...
## Track 2 — Batch #32: AI-Advanced 9 — Frontier & Capstone Integration ⭐ — overnight
- [2026-06-28 11:00] AJ01 — Reasoning Models & Process Supervision (o1-style CoT, test-time compute, ⭐ process vs outcome supervision chấm-bước-không-chỉ-đáp-án, PRM/verifier tự động, DE thu reasoning traces) — `notes/advanced/aj01-reasoning-models.md`
- [2026-06-28 11:00] AJ02 — AI Alignment & Safety (3 trụ HHH, SFT→RLHF/DPO→Constitutional AI/RLAIF, helpful↔harmless trade-off + refusal không over-refuse, jailbreak resistance, DE: data alignment+eval) — `notes/advanced/aj02-ai-alignment.md`
- [2026-06-28 11:00] AJ03 — ⭐ Capstone Integration CHẠY ĐƯỢC (ai_product.py: luồng 7 tầng guardrail→cache→retrieve→confidence→generate→validate→log; 4 đường đi OK/CACHE_HIT/BLOCKED/ESCALATE; calibrate CONF_MIN 0.55→0.72; mỗi tầng=1 nguyên tắc DE) — `projects/06-ai-data-engineering/ai_product.py`, `notes/advanced/aj03-capstone-integration.md`
- [2026-06-28 11:00] AJ04 — ⭐ Vector Compression CHẠY ĐƯỢC (Matryoshka cắt chiều + binary quant; BẤT NGỜ: binary giữ 88% recall ở /32 RAM, cắt 256 ok, cắt 64 tụt 62%; nén-lọc-thô→rerank-gốc; "trade-off phải ĐO") — `projects/06-ai-data-engineering/vector_compression.py`, `notes/advanced/aj04-nextgen-vector.md`
- [2026-06-28 11:30] AJ05 — Case Study: Healthcare AI (ràng buộc gắt: không bịa + PHI privacy + giải trình; grounding tuyệt đối + citation + human-in-loop bác sĩ + self-host + audit; eval recall-an-toàn + chuyên gia review) — `notes/advanced/aj05-case-healthcare-ai.md`
- [2026-06-28 11:30] AJ06 — Case Study: Finance AI (real-time lambda + compliance/audit nghiêm + point-in-time chống leakage + LLM-không-tự-quyết-tiền excessive-agency + explainability đúng không bịa) — `notes/advanced/aj06-case-finance-ai.md`
- [2026-06-28 11:30] AJ07 — LLM Data Flywheel (usage→signal→data→model→usage = data moat; 4 mắt xích DE thu/lọc/đưa-vào/đo; loại signal 👍👎/sửa/escalate/drift; lành mạnh vs độc hại chống collapse) — `notes/advanced/aj07-data-flywheel.md`
- [2026-06-28 11:30] AJ08 — Prompt Optimization tự động (few-shot selection liên-quan/đa-dạng/metric = dynamic-few-shot RAG ví dụ, DSPy compile từ signature+metric, APO, DE cung cấp pool+golden+harness+re-compile) — `notes/advanced/aj08-prompt-optimization.md`
- [2026-06-28 11:30] AJ09 — AI review 9 + **GRAND FINALE Module AI** (toàn cảnh 9 batch, 22 script portfolio, checklist "ngày 1 AI-DE", 3 điều ghi nhớ: danh-từ-đổi-tư-duy-không-đổi / đo-đừng-tin-mặc-định / phần-lớn-AI-là-DATA). **HOÀN THÀNH AI-ADVANCED 9 (AJ01–AJ09). Tổng 9 batch: ~91 note AI + 22 script.** — `notes/advanced/aj09-ai-review9.md`, `00-INDEX.md`

## Track 2 — Batch #33: AI-Advanced 10 — Vertical AI Case Studies ⭐ — overnight
- [2026-06-28 12:00] AK01 — Case E-commerce AI (search hybrid+ảnh, reco two-tower, tóm tắt review, chatbot; real-time tồn-kho/giá filter, cold-start content, đa ngữ, eval CTR/conversion) — `notes/advanced/ak01-case-ecommerce-ai.md`
- [2026-06-28 12:00] AK02 — Case Legal AI (citation chính xác tuyệt đối + verify điều-luật-có-thật, không bịa luật, privilege bảo mật, hiệu lực thời gian, human luật sư quyết) — `notes/advanced/ak02-case-legal-ai.md`
- [2026-06-28 12:00] AK03 — Case Education AI (personalization sư phạm đúng-độ-khó/ôn-chỗ-yếu, an toàn trẻ em, chính xác kiến thức, chống gian lận cho-hướng-không-đáp-án, đo tiến-bộ không engagement) — `notes/advanced/ak03-case-education-ai.md`
- [2026-06-28 12:00] AK04 — Case Government AI (minh bạch+công bằng+accessibility+đa ngữ+privacy công dân, fairness audit chất-lượng-đều-giữa-nhóm, không AI tự quyết việc hệ trọng, plain language) — `notes/advanced/ak04-case-govt-ai.md`
- [2026-06-28 12:00] AK05 — Case Manufacturing/IoT AI (time-series sensor scale, edge lọc/anomaly gửi-bất-thường-không-raw, predictive maintenance + LLM giải thích, LLM không tự dừng máy hậu-quả-vật-lý) — `notes/advanced/ak05-case-manufacturing-ai.md`
- [2026-06-28 12:30] AK06 — ⭐ Data Labeling CHẠY ĐƯỢC (Cohen's kappa trừ may rủi; A↔B 0.63 tốt, C lệch kappa~0 dù accuracy thô 33% = LỘ annotator ẩu accuracy giấu; gold question/active learning/weak-sup/AI-prelabel) — `projects/06-ai-data-engineering/annotation_agreement.py`, `notes/advanced/ak06-data-labeling.md`
...
- [2026-06-28 13:30] AL06 — Mock Interview 2 (system-design agent email + tool + SAFETY indirect-injection/least-privilege/human-approve + 4 câu ops drift/RLHF/vector-scale/eval-driven + STAR) — `notes/advanced/al06-mock-interview-2.md`
- [2026-06-28 13:30] AL07 — Coding Exercises 2 (5 bài governance/guardrails/DQ + lời giải: validate-schema, redact-PII, hard-gate, Cohen-kappa, self-consistency-so-FACT; VERIFY bài 3+4+5 chạy đúng) — `notes/advanced/al07-coding-exercises-2.md`
- [2026-06-28 13:30] AL08 — Case Insurance AI (claim/fraud/underwriting/RAG-hợp-đồng; explainability giải-trình-từ-chối + citation điều khoản, point-in-time, LLM không tự quyết chi trả) — `notes/advanced/al08-case-insurance-ai.md`
- [2026-06-28 13:30] AL09 — AI review 11 + **lộ trình luyện phỏng vấn 4 tuần** (concept→coding→system-design→mock) + tổng hợp tài nguyên ôn + 6 tips phỏng vấn. **HOÀN THÀNH AI-ADVANCED 11 (AL01–AL09). Tổng 11 batch: ~104 note AI + 23 script.** — `notes/advanced/al09-ai-review11.md`, `00-INDEX.md`

## Track 2 — Batch #35: AI-Advanced 12 — Deep Techniques & Debugging ⭐ — overnight
- [2026-06-28 14:00] AM01 — ⭐ RAG Debugger CHẠY ĐƯỢC (catalog failure modes theo tầng; chẩn đoán 4 ca: scd OK#1, EOS bị-cướp-top #147 gợi reformulate, marker not-indexed, tối ưu OK#4; chia retrieval-vs-generation) — `projects/06-ai-data-engineering/rag_debugger.py`, `notes/advanced/am01-rag-debugging.md`
- [2026-06-28 14:00] AM02 — Advanced Prompt Patterns (8 mẫu: zero/few-shot, CoT, ReAct, self-consistency, structured-output, role, step-back; khi-nào-dùng; tách data/instruction) — `notes/advanced/am02-prompt-patterns.md`
- [2026-06-28 14:00] AM03 — Advanced Chunking (6 chiến lược: fixed/structure/semantic/propositional/parent-child/late-chunking; parent-child nhỏ-tìm-to-trả; late-chunking embed-cả-doc) — `notes/advanced/am03-advanced-chunking.md`
- [2026-06-28 14:00] AM04 — ⭐ Hybrid Fusion RRF CHẠY ĐƯỢC (RRF gộp THỨ HẠNG không cần chuẩn-hoá-thang; PHÁT HIỆN: weighted+kw TỤT 88% keyword-nhiễu-kéo-nhầm nhưng RRF giữ 100% robust hơn; "thêm keyword không luôn tốt") — `projects/06-ai-data-engineering/rrf_fusion.py`, `notes/advanced/am04-hybrid-fusion.md`
- [2026-06-28 14:30] AM05 — Eval Metrics Deep (nDCG=DCG/IDCG graded-relevance, MAP=mean-AveP, recall-vs-precision theo hậu-quả-FP/FN, latency p95/p99 không-trung-bình, RAGAS faithfulness/context-precision-recall) — `notes/advanced/am05-eval-metrics-deep.md`
- [2026-06-28 14:30] AM06 — Case Gaming AI (NPC LLM cost/latency model-nhỏ+cache+routing, matchmaking Elo không-LLM, anti-cheat anomaly+human-ban, chat moderation real-time, anti-addiction) — `notes/advanced/am06-case-gaming-ai.md`
...
- [2026-06-28 15:30] AN05 — Case Travel AI (đa ngữ khách quốc tế + fairness chất-lượng-đều-ngôn-ngữ, real-time inventory + dynamic-pricing số-không-LLM, reco theo gu + cold-start, review thật) — `notes/advanced/an05-case-travel-ai.md`
- [2026-06-28 15:30] AN06 — Case Social Media AI Trust&Safety (⭐ engagement⇄safety: tối-ưu-engagement-mù khuếch-đại-độc-hại; moderation tầng AI-lọc+human scale tỉ-post; misinformation/bot/coordinated; fairness + chống over-moderation) — `notes/advanced/an06-case-social-ai.md`
- [2026-06-28 15:30] AN07 — Mock Interview 3 (system-design multimodal search/moderation scale: frame-sampling + moderation-tầng + cost-GPU-là-nghẽn + 4 câu chunk/fusion/drift/cost + STAR đơn-giản-hoá) — `notes/advanced/an07-mock-interview-3.md`
- [2026-06-28 15:30] AN08 — Coding Exercises 4 (5 bài router/agent/data + lời giải: query-router, ReAct-loop max-steps, provenance-log, budget-cap, point-in-time as-of; VERIFY bài 2+4+5 chạy đúng) — `notes/advanced/an08-coding-exercises-4.md`
- [2026-06-28 15:30] AN09 — AI review 13 + **bảng RAG-pattern→vấn-đề** + danh mục 15+ ngành + trạng thái curriculum (~290 note + 26 script) + 3 phát hiện code nổi bật. **HOÀN THÀNH AI-ADVANCED 13 (AN01–AN09). Tổng 13 batch: ~122 note AI + 26 script.** — `notes/advanced/an09-ai-review13.md`, `00-INDEX.md`
